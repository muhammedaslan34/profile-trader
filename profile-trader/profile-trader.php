...
class Profile_Trader {
    ...
    public function enqueue_assets() {
        ...
        if (!is_admin()) {
            ...
            wp_enqueue_style(
                'pt-dashboard',
                PT_PLUGIN_URL . 'assets/css/dashboard.css',
                ['intl-tel-input'],
                filemtime(PT_PLUGIN_DIR . 'assets/css/dashboard.css')
            );
            ...
            wp_enqueue_script(
                'pt-dashboard',
                PT_PLUGIN_URL . 'assets/js/dashboard.js',
                ['jquery', 'intl-tel-input', 'cropper-js'],
                filemtime(PT_PLUGIN_DIR . 'assets/js/dashboard.js'),
                true
            );
...
require_once PT_PLUGIN_DIR . 'includes/class-profile-handler.php';
require_once PT_PLUGIN_DIR . 'includes/class-trader-connection.php';
require_once PT_PLUGIN_DIR . 'includes/class-admin-settings.php';
