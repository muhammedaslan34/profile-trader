...
<div class="pt-dashboard" dir="rtl">
    ...
    <main class="pt-main">
        ...
        <div class="pt-content">
            ...
            switch ($active_tab) {
                case 'overview':
                    include PT_PLUGIN_DIR . 'templates/partials/overview.php';
                    break;
                case 'listings':
                    include PT_PLUGIN_DIR . 'templates/partials/listings-list.php';
                    break;
                case 'add-new':
                    include PT_PLUGIN_DIR . 'templates/partials/edit-form.php';
                    break;
                case 'edit':
                    include PT_PLUGIN_DIR . 'templates/partials/edit-form.php';
                    break;
                case 'jobs':
                    include PT_PLUGIN_DIR . 'templates/partials/job-listings.php';
                    break;
                case 'add-job':
                    include PT_PLUGIN_DIR . 'templates/partials/job-create-form.php';
                    break;
                case 'edit-job':
                    include PT_PLUGIN_DIR . 'templates/partials/job-create-form.php';
                    break;
                case 'profile':
                    include PT_PLUGIN_DIR . 'templates/partials/profile.php';
                    break;
                default:
                    include PT_PLUGIN_DIR . 'templates/partials/overview.php';
            }
